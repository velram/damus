...
final class NIP19Tests: XCTestCase {
    ...
    func test_parse_npub() throws {
        let res = parse_note_content(content: .content("nostr:npub10elfcs4fr0l0r8af98jlmgdh9c8tcxjvz9qkw038js35mp4dma8qzvjptg ")).blocks
    ...
    func test_parse_note() throws {
        let res = parse_note_content(content: .content(" nostr:note1s4p70596lv50x0zftuses32t6ck8x6wgd4edwacyetfxwns2jtysux7vep")).blocks
        XCTAssertEqual(res.count, 2)
